...
- [Link to parse XML with BS](https://www.geeksforgeeks.org/parsing-tables-and-xml-with-beautifulsoup/)
- [Fix for no entries](https://www.reddit.com/r/learnpython/comments/fo42bg/feedparser_no_entries/)
- [Examples of using feedparser for RSS](https://www.programcreek.com/python/example/558/feedparser.parse)
